...
/**
 * Spring Cloud Gateway 自定义全局过滤器，需要实现 GlobalFilter, Ordered接口
 * <p>
...
public class AuthorizeFilter implements GlobalFilter, Ordered {
     ...
     * 此方法是过滤器执行的主要逻辑
     *
     * @param exchange ServerWebExchange是当前请求和响应的上下文对象，
     *                 存放着重要的请求-响应属性、请求实例和响应实例等等。(相当于zuul中的RequestContext)
     * @param chain
     * @return
     */
    @Override
